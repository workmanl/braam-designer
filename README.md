...
A professional in-browser tool for designing, auditioning, and rendering cinematic braam sound effects using the Web Audio API.
...
- **Preset system** - Quick-start templates for common braam types
- **Export to WAV** - Render and download your designs as high-quality 48kHz audio files
- **Browser-based** - No installation required, runs entirely in your browser

## Live Demo

Try it out: [https://workmanl.github.io/braam-designer/](https://workmanl.github.io/braam-designer/)
...
1. Clone the repository:
   ```bash
   git clone https://github.com/workmanl/braam-designer.git
   cd braam-designer
   ```
