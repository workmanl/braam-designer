...
export const PRESETS: Preset[] = [
  {
    ...
    settings: {
      ...
      global: { masterDuration: 2.0, masterVolume: 0.85, hpfFreq: 20, lpfFreq: 400, saturationDrive: 0.3, saturationMix: 0.5, reverbMix: 0.6, reverbTime: 3.0, reverbDecay: 3.5 },
    },
  },
  {
    name: 'Inception Horn',
    settings: {
      ...
      global: { masterDuration: 2.8, masterVolume: 0.9, hpfFreq: 25, lpfFreq: 300, saturationDrive: 0.4, saturationMix: 0.6, reverbMix: 0.75, reverbTime: 3.8, reverbDecay: 4.0 },
    },
  },
  {
    name: 'Deep Foghorn',
    settings: {
      ...
      global: { masterDuration: 2.5, masterVolume: 0.88, hpfFreq: 22, lpfFreq: 350, saturationDrive: 0.25, saturationMix: 0.4, reverbMix: 0.7, reverbTime: 3.5, reverbDecay: 3.8 },
    },
  },
    {
    name: 'Trailer Impact',
    settings: {
      ...
      global: { masterDuration: 1.2, masterVolume: 0.9, hpfFreq: 20, lpfFreq: 500, saturationDrive: 0.5, saturationMix: 0.7, reverbMix: 0.5, reverbTime: 2.5, reverbDecay: 3.2 },
    },
  },
  {
    name: 'Rising Tension',
    settings: {
      ...
      global: { masterDuration: 2.5, masterVolume: 0.85, hpfFreq: 25, lpfFreq: 600, saturationDrive: 0.35, saturationMix: 0.55, reverbMix: 0.65, reverbTime: 3.2, reverbDecay: 3.0 },
    },
  },
  {
    ...
    settings: {
      ...
      global: { masterDuration: 2.8, masterVolume: 0.9, hpfFreq: 20, lpfFreq: 280, saturationDrive: 0.45, saturationMix: 0.65, reverbMix: 0.8, reverbTime: 4.0, reverbDecay: 4.0 },
    },
  },
  {
    name: 'Sub Drop',
    settings: {
      ...
      global: { masterDuration: 1.5, masterVolume: 0.92, hpfFreq: 20, lpfFreq: 450, saturationDrive: 0.6, saturationMix: 0.75, reverbMix: 0.45, reverbTime: 2.2, reverbDecay: 3.0 },
    },
  },
  {
    name: 'Epic Finale',
    settings: {
      ...
      global: { masterDuration: 3.5, masterVolume: 0.9, hpfFreq: 22, lpfFreq: 380, saturationDrive: 0.4, saturationMix: 0.6, reverbMix: 0.85, reverbTime: 4.0, reverbDecay: 4.5 },
    },
  },
];
