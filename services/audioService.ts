...
import type { BraamSettings, LayerSettings } from '../types';
...
const buildGraph = (context: BaseAudioContext, settings: BraamSettings) => {
...
export const play = async (settings: BraamSettings): Promise<void> => {
...
export const render = async (settings: BraamSettings): Promise<Blob> => {
    stop();
